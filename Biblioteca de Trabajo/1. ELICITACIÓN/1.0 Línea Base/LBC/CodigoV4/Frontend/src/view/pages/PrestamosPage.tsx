...
import { Loader2, Search, Filter, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <AppSidebar>
                    ...
                    <tr key={loan._id} className="hover:bg-muted/5 transition-colors">
                      ...
                      <td className="px-4 py-3 text-center">
                        <div className="flex flex-col gap-2 items-center">
                          ...
                          {/* Technician Validate Button for Specific Loan */}
                          {(user?.role === 'tecnico' || user?.role === 'admin') && loan.status === 'PENDIENTE_ENTREGA' && (
                            <Button
                              variant="outline"
                              size="sm"
      ...
      <Dialog open={showValidation} onOpenChange={setShowValidation}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Validar Préstamo</DialogTitle>
          </DialogHeader>
          <div className="py-4">
            <p className="text-sm text-muted-foreground mb-2">Ingrese el código proporcionado por el estudiante:</p>
            <Input
