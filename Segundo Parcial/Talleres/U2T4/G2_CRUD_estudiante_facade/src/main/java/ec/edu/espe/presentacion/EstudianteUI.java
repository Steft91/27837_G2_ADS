...
public class EstudianteUI extends javax.swing.JFrame {
    ...
    EstudianteFacade facade;
    DefaultTableModel modeloTabla;
    
    public EstudianteUI() {
        initComponents();
        facade = new EstudianteFacade();
    ...
    private void guardarbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarbtnActionPerformed
        try {
            ...
            String resultado = facade.crearEstudiante(id, nombre, edad);
    ...
    private void actualizarbtnActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            Estudiante resultado = facade.actualizarEstudiante(id, nombre, edad);
    ...
    private void eliminarbtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (confirmacion == javax.swing.JOptionPane.YES_OPTION) {
            String resultado = facade.eliminarEstudiante(id);
            javax.swing.JOptionPane.showMessageDialog(this, resultado);
    ...
    private void cargarDatosTabla() {
        ...
        ArrayList<Estudiante> estudiantes = facade.obtenerTodosLosEstudiantes();
